 ...
 * Build: http://modernizr.com/download/#-opacity-csstransforms-csstransitions-inputtypes-cssclasses-prefixed-testprop-testallprops-prefixes-domprefixes
 */

;window.Modernizr=function(a,b,c){function z(a){j.cssText=a}function A(a,b){return z(n.join(a+";")+(b||""))}function B(a,b){return typeof a===b}function C(a,b){return!!~(""+a).indexOf(b)}function D(a,b){for(var d in a){var e=a[d];if(!C(e,"-")&&j[e]!==c)return b=="pfx"?e:!0}return!1}function E(a,b,d){for(var e in a){var f=b[a[e]];if(f!==c)return d===!1?a[e]:B(f,"function")?f.bind(d||b):f}return!1}function F(a,b,c){var d=a.charAt(0).toUpperCase()+a.slice(1),e=(a+" "+p.join(d+" ")+d).split(" ");return B(b,"string")||B(b,"undefined")?D(e,b):(e=(a+" "+q.join(d+" ")+d).split(" "),E(e,b,c))}function G(){e.inputtypes=function(a){for(var d=0,e,f,h,i=a.length;d<i;d++)k.setAttribute("type",f=a[d]),e=k.type!=="text",e&&(k.value=l,k.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(f)&&k.style.WebkitAppearance!==c?(g.appendChild(k),h=b.defaultView,e=h.getComputedStyle&&h.getComputedStyle(k,null).WebkitAppearance!=="textfield"&&k.offsetHeight!==0,g.removeChild(k)):/^(search|tel)$/.test(f)||(/^(url|email)$/.test(f)?e=k.checkValidity&&k.checkValidity()===!1:e=k.value!=l)),s[a[d]]=!!e;return s}("search tel url email datetime date month week time datetime-local number range color".split(" "))}var d="2.8.3",e={},f=!0,g=b.documentElement,h="modernizr",i=b.createElement(h),j=i.style,k=b.createElement("input"),l=":)",m={}.toString,n=" -webkit- -moz- -o- -ms- ".split(" "),o="Webkit Moz O ms",p=o.split(" "),q=o.toLowerCase().split(" "),r={},s={},t={},u=[],v=u.slice,w,x={}.hasOwnProperty,y;!B(x,"undefined")&&!B(x.call,"undefined")?y=function(a,b){return x.call(a,b)}:y=function(a,b){return b in a&&B(a.constructor.prototype[b],"undefined")},Function.prototype.bind||(Function.prototype.bind=function(b){var c=this;if(typeof c!="function")throw new TypeError;var d=v.call(arguments,1),e=function(){if(this instanceof e){var a=function(){};a.prototype=c.prototype;var f=new a,g=c.apply(f,d.concat(v.call(arguments)));return Object(g)===g?g:f}return c.apply(b,d.concat(v.call(arguments)))};return e}),r.opacity=function(){return A("opacity:.55"),/^0.55$/.test(j.opacity)},r.csstransforms=function(){return!!F("transform")},r.csstransitions=function(){return F("transition")};for(var H in r)y(r,H)&&(w=H.toLowerCase(),e[w]=r[H](),u.push((e[w]?"":"no-")+w));return e.input||G(),e.addTest=function(a,b){if(typeof a=="object")for(var d in a)y(a,d)&&e.addTest(d,a[d]);else{a=a.toLowerCase();if(e[a]!==c)return e;b=typeof b=="function"?b():b,typeof f!="undefined"&&f&&(g.className+=" "+(b?"":"no-")+a),e[a]=b}return e},z(""),i=k=null,e._version=d,e._prefixes=n,e._domPrefixes=q,e._cssomPrefixes=p,e.testProp=function(a){return D([a])},e.testAllProps=F,e.prefixed=function(a,b,c){return b?F(a,b,c):F(a,"pfx")},g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(f?" js "+u.join(" "):""),e}(this,this.document);
(function($, undefined) {
...
*/
(function(e){function s(t,r){if(t.indexOf("#")===0){e(t).clone(true).appendTo(n.empty()).show()}else{if(r){var i=e("<iframe />").attr({src:t,frameborder:0,hspace:0}).css({width:"100%",height:"100%"});n.html(i)}else{n.load(t)}n.data("localEl",false)}}function o(e,i){var s=n.outerWidth(true),o={},u={};if(n.is(":visible")||r)return;r=true;var a=t.css("width");t.css("width",a);switch(e){case"left":n.css({left:"auto",right:"-"+s+"px"});o["margin-left"]="-="+s;u["right"]="+="+s;break;default:n.css({left:"-"+s+"px",right:"auto"});o["margin-left"]="+="+s;u["left"]="+="+s;break}t.animate(o,i);n.show().animate(u,i,function(){r=false})}var t=e("body"),n=e("#pageslide");var r=false,i;if(n.length==0){n=e("<div />").attr("id","pageslide").css("display","none").appendTo(e("body"))}e.fn.pageslide=function(t){var r=this;r.click(function(r){var s=e(this),o=e.extend({href:s.attr("href")},t);r.preventDefault();r.stopPropagation();if(n.is(":visible")&&s[0]==i){e.pageslide.close()}else{e.pageslide(o);i=s[0]}})};e.fn.pageslide.defaults={speed:200,direction:"right",modal:false,iframe:true,href:null};e.pageslide=function(r){var i=e.extend({},e.fn.pageslide.defaults,r);if(n.is(":visible")&&n.data("direction")!=i.direction){e.pageslide.close(function(){s(i.href,i.iframe);o(i.direction,i.speed)})}else{s(i.href,i.iframe);if(n.is(":hidden")){o(i.direction,i.speed)}}t.css("overflow","hidden");n.data(i)};e.pageslide.close=function(n){var i=e("#pageslide"),s=i.outerWidth(true),o=i.data("speed"),u={},a={};if(i.is(":hidden")||r)return;r=true;var f=t.css("width");t.css("width",f);switch(i.data("direction")){case"left":u["margin-left"]="+="+s;a["right"]="-="+s;break;default:u["margin-left"]="-="+s;a["left"]="-="+s;break}t.css("overflow","auto");i.animate(a,o);t.animate(u,o,function(){i.hide();t.css("width","");r=false;if(typeof n!="undefined")n()})};n.click(function(e){e.stopPropagation()});e(document).bind("click keyup",function(t){if(t.type=="keyup"&&t.keyCode!=27)return;if(n.is(":visible")&&!n.data("modal")){e.pageslide.close()}})})(jQuery)
